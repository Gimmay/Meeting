<?php
	...
	sub.team,
	(select name from user_employee where user_employee.id = sub.service_consultant) service_consultant,
	(select name from user_employee where user_employee.id = sub.develop_consultant) develop_consultant,
	sub.type,
