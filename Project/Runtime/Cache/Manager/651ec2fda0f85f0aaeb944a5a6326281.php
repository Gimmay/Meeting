...
<div class="mt_topbar clearfix">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<div class="btn-group" data-id="<?php echo ($single["id"]); ?>">
													<?php if($max_role_level <= $single['roleLevel']): if($permission_list['EMPLOYEE.ASSIGN-ROLE'] == 1): ?><button type="button" class="btn btn-default btn-xs btn_distribution_role" data-toggle="modal" data-target="#distribution_role">分配角色</button><?php endif; endif; ?>
													<?php if($permission_list['EMPLOYEE.ASSIGN-PERMISSION'] == 1): ?><button type="button" class="btn btn-default btn-xs authorize_btn" data-toggle="modal" data-target="#authorize_role">授权</button><?php endif; ?>
	...
	<!-- 分配角色 -->
	<?php if($permission_list['EMPLOYEE.ASSIGN-ROLE'] == 1): ?><div class="modal fade" id="distribution_role" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<!-- 员工授权 -->
	<?php if($permission_list['EMPLOYEE.ASSIGN-PERMISSION'] == 1): ?><div class="modal fade" id="authorize_role" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog" style="width: 80%">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
