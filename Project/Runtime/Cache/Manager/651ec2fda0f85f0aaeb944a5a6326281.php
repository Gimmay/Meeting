...
<div class="mt_topbar clearfix">
					...
					<section class="content">
						<header class="c_header">
							<div class="function_list clearfix">
								<?php if($permission_list['EMPLOYEE.CREATE'] == 1): ?><div class="function_btn bg-warning" data-toggle="modal" data-target="#create_employee">
										<a href="<?php echo U('Employee/create');?>"> <i></i>
											<p>新增员工</p>
										</a>
									</div><?php endif; ?>
								<?php if($permission_list['EMPLOYEE.DELETE'] == 1): ?><div class="function_btn bg-danger batch_delete_btn_confirm" data-toggle="modal" data-target="#batch_delete_employee">
										<i></i>
										<p>批量删除</p>
									</div><?php endif; ?>
							</div>
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<div class="btn-group" data-id="<?php echo ($single["id"]); ?>">
													<?php if(($max_role_level <= $single['roleLevel']) and ($permission_list['EMPLOYEE.ASSIGN-ROLE'] == 1) and ($permission_list['EMPLOYEE.ANTI-ASSIGN-ROLE'] == 1) and ($permission_list['EMPLOYEE.VIEW-ASSIGNED-ROLE'] == 1) and ($permission_list['EMPLOYEE.VIEW-UNASSIGNED-ROLE'] == 1)): ?><button type="button" class="btn btn-default btn-xs btn_distribution_role" data-toggle="modal" data-target="#distribution_role">分配角色</button><?php endif; ?>
													<?php if(($max_role_level <= $single['roleLevel']) and ($permission_list['EMPLOYEE.ASSIGN-PERMISSION'] == 1) and ($permission_list['EMPLOYEE.ANTI-ASSIGN-PERMISSION'] == 1) and ($permission_list['EMPLOYEE.VIEW-ASSIGNED-PERMISSION'] == 1) and ($permission_list['EMPLOYEE.VIEW-UNASSIGNED-PERMISSION'] == 1)): ?><button type="button" class="btn btn-default btn-xs authorize_btn" data-toggle="modal" data-target="#authorize_role">授权</button><?php endif; ?>
													<?php if($permission_list['EMPLOYEE.ALTER'] == 1): ?><a href="<?php echo U('Employee/alter',['id'=>$single['id']]);?>" type="button" class="btn btn-default btn-xs modify_btn">修改</a><?php endif; ?>
													<?php if($permission_list['EMPLOYEE.ALTER-PASSWORD'] == 1): ?><button type="button" class="btn btn-default btn-xs btn_alter_password" data-toggle="modal" data-target="#alter_password">修改密码</button><?php endif; ?>
													<?php if($permission_list['EMPLOYEE.RESET-PASSWORD'] == 1): ?><button type="button" class="btn btn-default btn-xs btn_reset_password" data-toggle="modal" data-target="#reset_password">重置密码</button><?php endif; ?>
													<?php if($permission_list['EMPLOYEE.DELETE'] == 1): ?><button type="button" class="btn btn-default btn-xs delete_btn" data-toggle="modal" data-target="#delete_employee">删除</button><?php endif; ?>
												</div>
											</td>
	...
	<!-- 删除员工 -->
	<?php if($permission_list['EMPLOYEE.DELETE'] == 1): ?><div class="modal fade" id="delete_employee" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<!-- 批量删除 -->
	<?php if($permission_list['EMPLOYEE.DELETE'] == 1): ?><div class="modal fade" id="batch_delete_employee" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
	...
	<!-- 分配角色 -->
	<?php if(($permission_list['EMPLOYEE.ASSIGN-ROLE'] == 1) and ($permission_list['EMPLOYEE.ANTI-ASSIGN-ROLE'] == 1) and ($permission_list['EMPLOYEE.VIEW-ASSIGNED-ROLE'] == 1) and ($permission_list['EMPLOYEE.VIEW-UNASSIGNED-ROLE'] == 1)): ?><div class="modal fade" id="distribution_role" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<!-- 员工授权 -->
	<?php if(($permission_list['EMPLOYEE.ASSIGN-PERMISSION'] == 1) and ($permission_list['EMPLOYEE.ANTI-ASSIGN-PERMISSION'] == 1) and ($permission_list['EMPLOYEE.VIEW-ASSIGNED-PERMISSION'] == 1) and ($permission_list['EMPLOYEE.VIEW-UNASSIGNED-PERMISSION'] == 1)): ?><div class="modal fade" id="authorize_role" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog" style="width: 80%">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
	...
	<!-- 修改密码 -->
	<?php if($permission_list['EMPLOYEE.ALTER-PASSWORD'] == 1): ?><div class="modal fade" id="alter_password" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
	...
	<!-- 重置密码 -->
	<?php if($permission_list['EMPLOYEE.RESET-PASSWORD'] == 1): ?><div class="modal fade" id="reset_password" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
