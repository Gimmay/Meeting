						...
						<div class="repertory clearfix">
							<form action="" method="get">
								<div class="input-group repertory_text">
									<input type="search" name="keyword" class="form-control" placeholder="券/拼音简码" value="<?php echo I('get.keyword', '');?>">
									<span class="input-group-btn">
										<button type="submit" class="btn btn-default mian_search">搜索券</button>
									</span>
								</div>
							...
							<form action="" method="get" class="checkbox_filter">
								...
								<div class="input-group pull-left used_filter">
									<input type="radio"  name="iCheck" class="icheck">&nbsp;&nbsp;已使用 (<?php echo ($statistics["used"]); ?>)
								</div>
							...
							<table class="table table-bordered" style="text-align: center">
								...
								<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tbody>
									<tr>
										...
										<td>
										<?php switch($info["status"]): case "0": ?>未使用<?php break;?>
											<?php case "1": ?>已使用<?php break;?>
											<?php case "2": ?>退费<?php break;?>
											<?php case "3": ?>删除<?php break; endswitch;?>
										</td>
										<td>
			...
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="post" action="" onsubmit="return checkCreate()">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="coupon_name" class="col-sm-2 control-label"><b style="vertical-align: middle;color: red;">*</b>券名称：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control name" name="name" id="coupon_name" value="<?php echo ($coupon["name"]); ?>" disabled>
							</div>
						</div>
						<div class="form-group">
							<label for="price" class="col-sm-2 control-label"><b style="vertical-align: middle;color: red;">*</b>价格：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control price" name="price" id="price" value="<?php echo ($coupon["price"]); ?>" disabled>
							</div>
						</div>
						<!-- 单个新增 -->
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group date form_datetime" id="start_time_wp">
									<input type="text" class="form-control start_time" name="start_time" id="start_time" value="<?php echo (date('Y-m-d',$coupon["start_time"])); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group date form_datetime" id="end_time_wp">
									<input type="text" class="form-control end_time" name="end_time" id="end_time" value="<?php echo (date('Y-m-d',$coupon["end_time"])); ?>">
									<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
								</div>
							</div>
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" action="" method="post" onsubmit="return checkAlter()">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="meeting_a" class="col-sm-2 control-label "><b style="vertical-align: middle;color: red;">*</b>会议：</label>
							<div class="col-sm-10">
								<div id="meeting_a"></div>
							</div>
						</div>
						<div class="form-group">
							<label for="coupon_name_a" class="col-sm-2 control-label "><b style="vertical-align: middle;color: red;">*</b>券名称：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control name" name="name" id="coupon_name_a" disabled>
							</div>
						</div>
						<div class="form-group">
							<label for="price_a" class="col-sm-2 control-label "><b style="vertical-align: middle;color: red;">*</b>价格：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control price" name="price" id="price_a" disabled>
							</div>
						</div>
						<div class="form-group">
							<label for="start_time_wp_a" class="col-sm-2 control-label "><b style="vertical-align: middle;color: red;">*</b>开始时间：</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="end_time_wp_a" class="col-sm-2 control-label "><b style="vertical-align: middle;color: red;">*</b>结束时间：</label>
							<div class="col-sm-10">
