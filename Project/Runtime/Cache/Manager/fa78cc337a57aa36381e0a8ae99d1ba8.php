							...
							<table class="table table-bordered" style="text-align: center">
								...
								<tbody>
									<?php if(is_array($coupon_list)): $i = 0; $__LIST__ = $coupon_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
										...
										<td class="name"><?php echo ($list["name"]); ?></td>
										<td><?php echo ($list["type"]); ?></td>
										<td><?php echo ($list["meeting"]); ?></td>
										<td><a href="<?php echo U('details',['id'=>$list['id']]);?>" class="link color-primary"><?php echo ($list["count"]); ?></a></td>
										<td class="price"><?php echo ($list["price"]); ?></td>
										<td class="start_time"><?php echo (date('Y-m-d',$list["start_time"])); ?></td>
										<td class="end_time"><?php echo (date('Y-m-d',$list["end_time"])); ?></td>
										<td class="comment"><?php echo ($list["comment"]); ?></td>
										<td>
		...
		<div class="modal-dialog" style="width: 60%">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h2 class="modal-title" id="create_role_title">新增券</h2>
				</div>
				<form class="form-horizontal" role="form" method="post" action="" onsubmit="return checkCreate()">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="coupon_type1" class="col-sm-2 control-label"><b style="vertical-align: middle;color: red;">*</b>类型：</label>
							<div class="col-sm-10">
								<div id="coupon_type1"></div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="create_role_comment" class="col-sm-2 control-label"></label>
							<div class="col-sm-10">
			...
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" action="" method="post" onsubmit="return checkAlter()">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="coupon_type2" class="col-sm-2 control-label"><b style="vertical-align: middle;color: red;">*</b>类型：</label>
							<div class="col-sm-10">
								<div id="coupon_type2"></div>
							</div>
						</div>
						<div class="form-group">
	...
	<script>
		var ManageObject = {
			object:{
				...
				typeSelect:$('#coupon_type1,#coupon_type2').QuasarSelect({
					name        :'type',
					classStyle  :'form-control',
					data        :'<?php echo json_encode($meeting_list);?>',
					idInput     :'selected_coupon_type',
					idHidden    :'selected_coupon_type_form',
					placeholder :'',
					hasEmptyItem:false
				}),
