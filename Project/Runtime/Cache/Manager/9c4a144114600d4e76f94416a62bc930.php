...
<div class="mt_topbar clearfix">
					...
					<section class="content">
						<header class="c_header">
							<div class="function_list clearfix">
								<div class="function_btn bg-warning" data-toggle="modal" data-target="#create_role">
									<i></i>
									<p>新增角色</p>
								</div>
								<div class="function_btn bg-danger batch_delete_btn_confirm" data-toggle="modal" data-target="#batch_delete_employee">
									<i></i>
									<p>批量删除</p>
								</div>
							</div>
						...
						<div class="table_wrap">
							<table class="table table-bordered" style="text-align: center">
								...
								<tbody>
									<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single): $mod = ($i % 2 );++$i;?><tr>
											<td class="check_item">
											...
											<td><?php echo ($single["count"]); ?></td>
											<td><?php echo ($single["level"]); ?></td>
											<td>
												<?php if($single[effect] == 0): ?>(系统全局)
													<?php else: echo ($single["meeting"]); endif; ?>
											</td>
											...
											<td>
												<div class="btn-group" data-id="<?php echo ($single["id"]); ?>">
													<?php if($max_role_level <= $single['level']): ?><button type="button" class="btn btn-default btn-xs authorize_btn" data-toggle="modal" data-target="#authorize_role">授权</button>
														<button type="button" class="btn btn-default btn-xs modify_btn" data-toggle="modal" data-target="#modify_role">修改</button>
														<button type="button" class="btn btn-default btn-xs delete_btn" data-toggle="modal" data-target="#delete_role">删除</button><?php endif; ?>
												</div>
											</td>
	...
	<!-- 修改角色 -->
	<div class="modal fade" id="modify_role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">
				...
				<form class="form-horizontal" role="form" action="<?php echo U('alterRole');?>" method="post">
	...
	<!-- 删除角色 -->
	<div class="modal fade" id="delete_role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">
