...
<div class="mt_topbar clearfix">
					...
					<section class="content">
						<header class="c_header">
							<div class="function_list clearfix">
								<?php if($permission_list['createRole'] == 1): ?><div class="function_btn bg-warning" data-toggle="modal" data-target="#create_role">
										<i></i>
										<p>新增角色</p>
									</div><?php endif; ?>
								<?php if($permission_list['deleteRole'] == 1): ?><div class="function_btn bg-danger batch_delete_btn_confirm" data-toggle="modal" data-target="#batch_delete_employee">
										<i></i>
										<p>批量删除</p>
									</div><?php endif; ?>
							</div>
									...
									<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single): $mod = ($i % 2 );++$i; if($max_role_level <= $single['level']): ?><tr>
												...
												<td>
													<div class="btn-group" data-id="<?php echo ($single["id"]); ?>">
														<?php if($max_role_level <= $single['level']): if($permission_list['assignPermissionForRole'] == 1): ?><button type="button" class="btn btn-default btn-xs authorize_btn" data-toggle="modal" data-target="#authorize_role">授权</button><?php endif; ?>
															<?php if($permission_list['alterRole'] == 1): ?><button type="button" class="btn btn-default btn-xs modify_btn" data-toggle="modal" data-target="#modify_role">修改</button><?php endif; ?>
															<?php if($permission_list['deleteRole'] == 1): ?><button type="button" class="btn btn-default btn-xs delete_btn" data-toggle="modal" data-target="#delete_role">删除</button><?php endif; endif; ?>
													</div>
												</td>
	...
	<!-- 新增角色 -->
	<?php if($permission_list['createRole'] == 1): ?><div class="modal fade" id="create_role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<!-- 修改角色 -->
	<?php if($permission_list['alterRole'] == 1): ?><div class="modal fade" id="modify_role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
	...
	<!-- 删除角色 -->
	<?php if($permission_list['deleteRole'] == 1): ?><div class="modal fade" id="delete_role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
	...
	<!-- 角色授权 -->
	<?php if($permission_list['assignPermissionForRole'] == 1): ?><div class="modal fade" id="authorize_role" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<!-- 批量删除 -->
	<?php if($permission_list['deleteRole'] == 1): ?><div class="modal fade" id="batch_delete_employee" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">
