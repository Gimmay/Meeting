...
<div class="mt_topbar clearfix">
									...
									<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single): $mod = ($i % 2 );++$i; if($max_role_level <= $single['level']): ?><tr>
												...
												<td>
													<div class="btn-group" data-id="<?php echo ($single["id"]); ?>">
														<?php if($max_role_level <= $single['level']): if(($permission_list['ROLE.ASSIGN-PERMISSION'] == 1) and ($permission_list['ROLE.ANTI-ASSIGN-PERMISSION'] == 1) and ($permission_list['ROLE.VIEW-ASSIGNED-PERMISSION'] == 1) and ($permission_list['ROLE.VIEW-UNASSIGNED-PERMISSION'] == 1)): ?><button type="button" class="btn btn-default btn-xs authorize_btn" data-toggle="modal" data-target="#authorize_role">授权</button><?php endif; ?>
	...
	<!-- 角色授权 -->
	<?php if(($permission_list['ROLE.ASSIGN-PERMISSION'] == 1) and ($permission_list['ROLE.ANTI-ASSIGN-PERMISSION'] == 1) and ($permission_list['ROLE.VIEW-ASSIGNED-PERMISSION'] == 1) and ($permission_list['ROLE.VIEW-UNASSIGNED-PERMISSION'] == 1)): ?><div class="modal fade" id="authorize_role" tabindex="3" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="modal-body role_body">
							...
							<div class="btn_rect but_wrap">
								...
								<section class="all_area clearfix" id="authorize_all">
									<!--<div class="pannel_n" data-group="aaa">
										<div>
											<header class="title">什么权限</header>
											<section>
												<a class="btn btn-default btn-sm" href="javascript:void(0)" role="button" data-id="41" data-type="$type">取消签到</a>
											</section>
										</div>
									</div>-->
								</section>
