			...
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" action="" method="post" onsubmit="return checkAlter()">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="start_time_wp_a" class="col-sm-2 control-label color-red"><b style="vertical-align: middle">*</b>开始时间：</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="end_time_wp_a" class="col-sm-2 control-label color-red"><b style="vertical-align: middle">*</b>结束时间：</label>
							<div class="col-sm-10">
